@extends('esoft.layouts.base' , [ 'title' => '404'])
    ...
    <div class="container">
      ...
      <div class="row align-items-center">
        <div class="col-lg-8 m-auto">
          <div class="erro-page">
            <div class="image">
              <img src="/templates/esoft/img/others/error.png" alt="" />
            </div>
            <div class="headding2 text-center">
              ...
              <a href="{{ route('esoft.any', 'index') }}" class="theme-btn2">Go Back To Home Page</a>
            </div>
          </div>
        </div>
      </div>
