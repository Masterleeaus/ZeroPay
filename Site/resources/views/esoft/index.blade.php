@extends('esoft.layouts.base', ['title' => 'Web Page Builder', 'logo5' => true])
...
@section('content')
  ...
  @include('esoft.layouts.partials.header.navbar')
  ...
  <div class="hero-area6">
    ...
    <div class="row align-items-center">
      ...
      <div class="main-heading">
        <span class="span" data-aos="fade-left" data-aos-duration="700"><img src="/templates/esoft/img/icons/main-span6.png" alt="" /> Top Choice For 5,800+ Websites Worldwide</span>
      ...
      <div class="images-all" data-aos="zoom-out" data-aos-duration="800">
        <div class="image1">
        <img src="/templates/esoft/img/hero/hero6-img1.png" alt="" />
        </div>
        <div class="image2 animate1">
        <img src="/templates/esoft/img/hero/hero6-img2.png" alt="" />
        </div>
        <div class="image3 shape-animaiton2">
        <img src="/templates/esoft/img/hero/hero6-img3.png" alt="" />
        </div>
      </div>
      </div>
    </div>
  ...
  <div class="editing6 sp">
    ...
    <div class="row">
      ...
      <div class="heading6">
        <span class="title"><img src="/templates/esoft/img/icons/span-image6.png" alt="" /></span>
    ...
    <div class="row">
      ...
      <div class="editing-box">
        <div class="icon">
        <img src="/templates/esoft/img/icons/editing6-icon1.svg" alt="" />
        </div>
        <div class="space16"></div>
        <div class="heading6">
        <h4><a href="{{ route('esoft.second', ['pages', 'features']) }}">Drag & Drop Editing</a></h4>
        <div class="space16"></div>
      ...
      <div class="editing-box">
        <div class="icon">
        <img src="/templates/esoft/img/icons/editing6-icon2.svg" alt="" />
        </div>
        <div class="space16"></div>
        <div class="heading6">
        <h4><a href="{{ route('esoft.second', ['pages', 'features']) }}">True Visual Editing</a></h4>
        <div class="space16"></div>
      ...
      <div class="editing-box">
        <div class="icon">
        <img src="/templates/esoft/img/icons/editing6-icon3.svg" alt="" />
        </div>
        <div class="space16"></div>
        <div class="heading6">
        <h4><a href="{{ route('esoft.second', ['pages', 'features']) }}">Custom CSS Control</a></h4>
        <div class="space16"></div>
      ...
      <div class="editing-box">
        <div class="icon">
        <img src="/templates/esoft/img/icons/editing6-icon4.svg" alt="" />
        </div>
        <div class="space16"></div>
        <div class="heading6">
        <h4><a href="{{ route('esoft.second', ['pages', 'features']) }}">Responsive Editing</a></h4>
        <div class="space16"></div>
      ...
      <div class="editing-box">
        <div class="icon">
        <img src="/templates/esoft/img/icons/editing6-icon5.svg" alt="" />
        </div>
        <div class="space16"></div>
        <div class="heading6">
        <h4><a href="{{ route('esoft.second', ['pages', 'features']) }}">Copy/Paste Design</a></h4>
        <div class="space16"></div>
      ...
      <div class="editing-box">
        <div class="icon">
        <img src="/templates/esoft/img/icons/editing6-icon6.svg" alt="" />
        </div>
        <div class="space16"></div>
        <div class="heading6">
        <h4><a href="{{ route('esoft.second', ['pages', 'features']) }}">Global Element Styles</a></h4>
        <div class="space16"></div>
  ...
  <div class="features6 sp">
    ...
    <div class="row align-items-center">
      ...
      <div class="main-image right60" data-aos="zoom-out" data-aos-duration="800">
        <img src="/templates/esoft/img/others/features6-img1.png" alt="" />
      </div>
      </div>
      <div class="col-1"></div>
      <div class="col-lg-5">
      <div class="heading6 features-heading">
        ...
        <a href="{{ route('esoft.second', ['pages', 'features']) }}" class="theme-btn9"><span class="tb8">Get More Info <span class="arrow"><i class="fa-solid fa-arrow-right"></i></span></span></a>
        </div>
      </div>
      </div>
    </div>
    ...
    <div class="row align-items-center">
      ...
      <div class="main-image right60" data-aos="zoom-out" data-aos-duration="1000">
        <img src="/templates/esoft/img/others/features6-img2.png" alt="" />
      </div>
      </div>
    </div>
    ...
    <div class="row align-items-center">
      ...
      <div class="main-image right60" data-aos="zoom-out" data-aos-duration="1100">
        <img src="/templates/esoft/img/others/features6-img3.png" alt="" />
      </div>
      </div>
      <div class="col-1"></div>
      <div class="col-lg-5">
    ...
    <div class="row align-items-center">
      ...
      <div class="col-lg-6">
      <div class="main-image right60" data-aos="zoom-out" data-aos-duration="800">
        <img src="/templates/esoft/img/others/features6-img4.png" alt="" />
      </div>
      </div>
    </div>
    ...
    <div class="row align-items-center">
      <div class="col-lg-6">
      <div class="main-image right60" data-aos="zoom-out" data-aos-duration="1000">
        <img src="/templates/esoft/img/others/features6-img5.png" alt="" />
      </div>
      </div>
      <div class="col-1"></div>
      <div class="col-lg-5">
  ...
  <div class="brands-area6 sp">
    ...
    <div class="row align-items-center">
      ...
      <div class="heading6-w">
        ...
        <div class="space30"></div>
        <div class="" data-aos="fade-left" data-aos-duration="1000">
        <a href="{{ route('esoft.second', ['auth', 'account']) }}" class="theme-btn8"><span class="tb8">Get Started, It’s Free <span class="arrow"><i class="fa-solid fa-arrow-right"></i></span></span></a>
        </div>
      </div>
      </div>
      ...
      <div class="apps-images">
        <div class="image1">
        <img src="/templates/esoft/img/bg/apps5-shape-bg.png" alt="" />
        <div class="dot"></div>
        </div>
        <div class="image2">
        <img src="/templates/esoft/img/others/apps5.png" alt="" />
        </div>
      </div>
      </div>
    </div>
  ...
  <div class="cta6">
    ...
    <div class="row align-items-center">
      ...
      <div class="cta6-images">
        <div class="image1">
        <img src="/templates/esoft/img/others/cta6-img.png" alt="" />
        </div>
        <div class="image2">
        <img src="/templates/esoft/img/shapes/cta6-shape.png" alt="" />
        </div>
      </div>
      </div>
    </div>
  ...
  <div class="footer6 _relative">
    ...
    <div class="copyright-area">
      ...
      <div class="col-md-5">
        <div class="logo">
        <a href="{{ route('esoft.any', 'index') }}"><img src="/templates/esoft/img/logo/footer-logo6.png" alt="" /></a>
        </div>
      </div>
      <div class="col-md-7">
