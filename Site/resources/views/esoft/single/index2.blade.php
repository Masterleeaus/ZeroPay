...
@section('content')
  ...
  @include('esoft.layouts.partials.header-single.navbar2')
          ...
          <div class="col-lg-7 m-auto text-center">
            <div class="main-heading">
              ...
              <div class="buttons" data-aos="fade-up" data-aos-duration="900">
                ...
                <a href="#" class="theme-btn7"><span class="arrow"><img src="/templates/esoft/img/icons/home5-btn-icon1.svg" alt="" /></span> Get a Demo</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="heading5-w">
              ...
              <div class="space30"></div>
              <a href="#" class="theme-btn7"><span class="arrow"><img src="/templates/esoft/img/icons/home5-btn-icon1.svg" alt="" /></span> Sign Up Now</a>
            </div>
          </div>
          <div class="col-lg-6">
            <div class="main-image">
