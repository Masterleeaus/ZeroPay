@extends('esoft.layouts.base' , [ 'title' => 'Email Marketing Sass Landing Page' , 'logo3' => true])
...
@section('content')
  ...
  @include('esoft.layouts.partials.header-single.navbar8')

  <!-- ===== HERO AREA START ======= -->
  <div class="hero-area3" style="background-image: url(/templates/esoft/img/bg/header3-bg.png);">
    <div class="container">
      <div class="hero4-mid-area">
        ...
        <div class="main-img">
          <img src="/templates/esoft/img/hero/header3-main-img.png" alt="" />
        </div>
      </div>
    </div>
  </div>
  ...
  <div data-bs-spy="scroll" data-bs-target="#list-example" data-bs-offset="0" class="scrollspy-example" tabindex="0">
    <!-- ===== SERVICE AREA START ======= -->
    <div class="service3 sp" id="service">
      <div class="container">
        <div class="row">
              ...
              <div class="tabs-boxs">
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                  <li class="nav-item" role="presentation" data-aos="fade-up" data-aos-duration="800">
                    <button class="nav-link active" id="service-items1-tab" data-bs-toggle="pill" data-bs-target="#service-items1" type="button" role="tab" aria-controls="service-items1" aria-selected="true"><img src="/templates/esoft/img/icons/service3-icon1.png" alt="" /> <br /> <span>SEO</span></button>
                  </li>
                  <li class="nav-item" role="presentation" data-aos="fade-up" data-aos-duration="1000">
                    <button class="nav-link" id="service-items2-tab" data-bs-toggle="pill" data-bs-target="#service-items2" type="button" role="tab" aria-controls="service-items2" aria-selected="false"><img src="/templates/esoft/img/icons/service3-icon2.png" alt="" /> <br /> <span>Content Marketing</span></button>
                  </li>
                  <li class="nav-item" role="presentation" data-aos="fade-up" data-aos-duration="900">
                    <button class="nav-link" id="service-items3-tab" data-bs-toggle="pill" data-bs-target="#service-items3" type="button" role="tab" aria-controls="service-items3" aria-selected="false"><img src="/templates/esoft/img/icons/service3-icon3.png" alt="" /> <br /> <span>Market Research</span></button>
                  </li>
                  <li class="nav-item" role="presentation" data-aos="fade-up" data-aos-duration="1100">
                    <button class="nav-link" id="service-items4-tab" data-bs-toggle="pill" data-bs-target="#service-items4" type="button" role="tab" aria-controls="service-items4" aria-selected="false"><img src="/templates/esoft/img/icons/service3-icon4.png" alt="" /> <br /> <span>Advertising</span></button>
                  </li>
                  <li class="nav-item" role="presentation" data-aos="fade-up" data-aos-duration="900">
                    <button class="nav-link" id="service-items5-tab" data-bs-toggle="pill" data-bs-target="#service-items5" type="button" role="tab" aria-controls="service-items5" aria-selected="false"><img src="/templates/esoft/img/icons/service3-icon5.png" alt="" /> <br /> <span>Social Media</span></button>
                  </li>
                </ul>
              </div>
                      ...
                      <div class="row">
                        <div class="col-lg-6">
                          <div class="tab-bottom-headding">
                            ...
                            <a class="immiPressBtn" href="{{ route('esoft.second', ['pages', 'contact']) }}"><span>Boost My Rankings</span> <span class="arrow"><i class="fa-regular fa-arrow-right"></i></span></a>
                          </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                          <div class="tab-bottom-images">
                            <div class="img1">
                              <img src="/templates/esoft/img/service/service3-img1.png" alt="" />
                            </div>
                            <div class="img2 shape-animaiton3">
                              <img src="/templates/esoft/img/service/service3-img2.png" alt="" />
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-lg-6">
                          <div class="tab-bottom-headding">
                            ...
                            <a class="immiPressBtn" href="{{ route('esoft.second', ['pages', 'features']) }}"><span>Boost My Rankings</span> <span class="arrow"><i class="fa-regular fa-arrow-right"></i></span></a>
                          </div>
                        </div>
    ...
    <!-- ===== STIKY AREA START ======= -->
    <div class="stiky-sec sp" id="stiky" style="background-image: url(/templates/esoft/img/bg/stiky-bg.png); background-position: center center; background-repeat: no-repeat; background-size: cover;">
      <div class="container">
        <div class="row">
          <div class="col-lg-6 m-auto text-center">
            <div class="headding3">
                ...
                <div class="row align-items-center">
                  <div class="col-lg-6">
                    <div class="headding">
                      ...
                      <a class="immiPressBtn" href="{{ route('esoft.second', ['pages', 'features']) }}"><span>Unlock SEO Power</span> <span class="arrow"><i class="fa-regular fa-arrow-right"></i></span></a>
                    </div>
                  </div>
                  <div class="col-lg-6">
                    <div class="stiky-sec-img">
                      <img src="/templates/esoft/img/others/stiky-sec-img1.png" alt="" />
                      <img class="shape" src="/templates/esoft/img/shapes/stiky-sec-shape.png" alt="" />
                    </div>
                  </div>
                </div>
              </div>
    ...
    <!-- ===== PRIICING AREA START ======= -->
    <div class="pricing-plan sp" id="pricing">
      <div class="container">
        <div class="row">
          <div class="col-md-6 m-auto text-center">
            <div class="headding3">
              <h2 data-aos="fade-up" data-aos-duration="800">Our Plan Makes You Feel <span class="after">More</span> Comfortable In Financial</h2>
              <p></p>
            </div>
          </div>
        </div>
                ...
                <div class="row">
                  <div class="col-md-6 col-lg-4">
                    <div class="pricing-box" data-aos="fade-up" data-aos-duration="1100">
                      <div class="pricing-box-single">
                        <div class="image">
                          <img src="/templates/esoft/img/pricing/pricing-img1.png" alt="" />
                        </div>
                        <h4>Strater</h4>
                        ...
                        <div class="space20"></div>
                        <div class="button">
                          <a class="immiPressBtn" href="{{ route('esoft.second', ['auth', 'account']) }}"><span>Start Free Trail</span> <span class="arrow"><i class="fa-regular fa-arrow-right"></i></span></a>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6 col-lg-4">
                    <div class="pricing-box" data-aos="fade-up" data-aos-duration="900">
                      <div class="pricing-box-single">
                        <div class="image">
                          <img src="/templates/esoft/img/pricing/pricing-img2.png" alt="" />
                        </div>
                        <h4>Business</h4>
                        <p>Search engine ranks effortlessly with our a powerful and intuitive best software eSoft</p>
                        <p class="span-headding">
                  ...
                  <div class="col-md-6 col-lg-4">
                    <div class="pricing-box" data-aos="fade-up" data-aos-duration="1000">
                      <div class="pricing-box-single">
                        <div class="image">
                          <img src="/templates/esoft/img/pricing/pricing-img3.png" alt="" />
                        </div>
    ...
    <!-- ===== CTA AREA START ======= -->
    <div class="cta3" style="background-image: url(/templates/esoft/img/bg/cta3-bg.png); background-position: center center; background-size: cover; background-repeat: no-repeat;">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-7">
            <div class="headding3">
      ...
      <div class="container">
          ...
          <div class="col-lg-4 m-auto text-center">
            <div class="headding3">
              ...
              <div class="" data-aos="fade-up" data-aos-duration="900">
                <a href="{{ route('esoft.second', ['pages', 'features']) }}" class="learn">Explore Our Integration Library <span><i class="fa-regular fa-arrow-right"></i></span></a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="big-logo" data-tilt data-tilt-full-page-listening data-tilt-perspective="3000">
            <img src="/templates/esoft/img/logo/brand-logo3.png" alt="" />
          </div>
        </div>
      </div>
    </div>
    ...
    <!-- ===== TES AREA START ======= -->
    <div class="tes3 sp" id="tes" style="background-image: url(/templates/esoft/img/bg/tes3-bg.png); background-position: center center; background-repeat: no-repeat; background-size: cover;">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6">
            <div class="headding2">
          ...
          <div class="col-lg-12">
            <div class="tes2-slider-all" data-aos="fade-up" data-aos-duration="1000">
              <div class="single-slider">
                ...
                <div class="icon">
                  <img src="/templates/esoft/img/icons/tes-icon3.png" alt="" />
                </div>
          ...
          <div class="col-lg-5">
            <div class="headding3">
              ...
              <div class="" data-aos="fade-right" data-aos-duration="1000">
                <a href="{{ route('esoft.second', ['blogs', 'blog']) }}" class="immiPressBtn"><span>Read more blog</span> <span class="arrow"><i class="fa-regular fa-arrow-right"></i></span></a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-7">
            <div class="blog-boxs">
              <div class="blog-single-box" data-aos="fade-up" data-aos-duration="1000">
                <div class="image">
                  <img src="/templates/esoft/img/blog/blog3-img1.png" alt="" />
                </div>
                <div class="headding">
                  <h4><a href="{{ route('esoft.second', ['blogs', 'details']) }}">Digital Domination: SEO Strategies That Work</a></h4>
              ...
              <div class="blog-single-box" data-aos="fade-up" data-aos-duration="1100">
                ...
                <div class="headding">
                  <h4><a href="{{ route('esoft.second', ['blogs', 'details']) }}">Optimising Success: The Best SEO Playbook</a></h4>
                  <p>SEO tasks are streamlined, allowing you to focus on strategic initiatives while.</p>
                  <a href="{{ route('esoft.second', ['blogs', 'details']) }}" class="learn">Read more <span><i class="fa-regular fa-arrow-right"></i></span></a>
                </div>
              </div>
  ...
  <!-- ===== CTA 2 AREA END ======= -->
  <div class="cta3-3" style="background-image: url(/templates/esoft/img/bg/cta3-2.png); background-position: center center; background-repeat: no-repeat; background-size: cover;">
    <div class="container">
      <div class="row">
        <div class="col-lg-6 m-auto text-center">
          <div class="headding3">
            ...
            <div class="space20"></div>
            <div class="">
              <a href="{{ route('esoft.second', ['auth', 'account']) }}" class="immiPressBtn"><span>Start your free trail</span> <span class="arrow"><i class="fa-regular fa-arrow-right"></i></span></a>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="footer3 _relative">
    <div class="container">
      <div class="row">
        <div class="col-lg-4">
          <div class="subscribe-area" style="background-image: url(/templates/esoft/img/bg/footer3-sebscribe-bg.png); background-position: center; background-size: cover; background-repeat: no-repeat;">
            <h5>Subscribe to our newsletter</h5>
            <p>eSoft has exceeded our expectations every way. The ease with & which Search Engine</p>
            <div class="input-area">
              <input type="email" placeholder="Email" />
              <div class="button">
                <button type="submit" class="immiPressBtn"><span>SSubscribe</span> <span class="arrow"><i class="fa-regular fa-arrow-right"></i></span></button>
              </div>
            </div>
          </div>
        </div>
