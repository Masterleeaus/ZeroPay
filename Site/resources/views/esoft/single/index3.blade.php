@extends('esoft.layouts.base' , [ 'title' => 'POS Software' , 'logo5' => true])
...
@section('content')
  ...
  @include('esoft.layouts.partials.header-single.navbar3')
      ...
      <div class="row align-items-center">
        <div class="col-lg-5">
          <div class="main-heading">
            <span class="span" data-aos="fade-left" data-aos-duration="800"><img src="/templates/esoft/img/icons/main-span6.png" alt="" /> Top Choice For 5,800+ Websites Worldwide</span>
            ...
            <div class="buttons" data-aos="fade-left" data-aos-duration="1100">
              <a href="#" class="theme-btn10">App Store <span class="arrow"><i class="fa-solid fa-arrow-right"></i></span></a>
        ...
        <div class="col-lg-7">
          <div class="images-all">
            <div class="image1">
              <img src="/templates/esoft/img/shapes/hero7-main-shape.png" alt="" />
            </div>
            <div class="image2">
              <img src="/templates/esoft/img/hero/hero7-main-img.png" alt="" />
            </div>
            <div class="shape1 shape-animaiton3">
              <img src="/templates/esoft/img/shapes/hero7-shape1.png" alt="" />
            </div>
            <div class="shape2 animate1">
              <img src="/templates/esoft/img/shapes/hero7-shape2.png" alt="" />
            </div>
            <div class="shape3 animate3 shape-animaiton2">
              <img src="/templates/esoft/img/shapes/hero7-shape3.png" alt="" />
            </div>
            <div class="shape4 shape-animaiton2">
              <img src="/templates/esoft/img/shapes/hero7-shape4.png" alt="" />
            </div>
          </div>
        </div>
      </div>
  ...
  <div data-bs-spy="scroll" data-bs-target="#list-example" data-bs-offset="0" class="scrollspy-example" tabindex="0">
        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="images-left-all">
              <div class="image1">
                <img src="/templates/esoft/img/about/about7-left-img1.png" alt="" />
              </div>
              <div class="image2 shape-animaiton2">
                <img src="/templates/esoft/img/about/about7-left-img2.png" alt="" />
              </div>
              <div class="image3 shape-animaiton3">
                <img src="/templates/esoft/img/about/about7-left-img3.png" alt="" />
              </div>
              <div class="image4 shape-animaiton2">
                <img src="/templates/esoft/img/about/about7-left-img4.png" alt="" />
              </div>
              <div class="image5">
                <img src="/templates/esoft/img/about/about7-left-img5.png" alt="" />
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-6">
            <div class="images-right-all">
              <div class="image1" data-aos="zoom-out" data-aos-duration="700">
                <img src="/templates/esoft/img/about/about7-right-img1.png" alt="" />
              </div>
              <div class="image2" data-aos="flip-right" data-aos-duration="800">
                <img src="/templates/esoft/img/about/about7-right-img2.png" alt="" />
              </div>
              <div class="image3">
                <img src="/templates/esoft/img/about/about7-right-img3.png" alt="" />
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="work-prosess7 sp _relative" id="work-prosess">
      <div class="container">
        <div class="row">
        ...
        <div class="row align-items-center">
          <div class="col-lg-4">
            <div class="work-bottom-box">
              <div class="image">
                <img src="/templates/esoft/img/work/work-prosses7-bottom1.png" alt="" />
              </div>
              <div class="shape1">
                <img src="/templates/esoft/img/work/work-prosses7-bottom-shape1.png" alt="" />
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4">
            <div class="work-bottom-box">
              <div class="image">
                <img src="/templates/esoft/img/work/work-prosses7-bottom2.png" alt="" />
              </div>
              <div class="shape2">
                <img src="/templates/esoft/img/work/work-prosses7-bottom-shape2.png" alt="" />
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4">
            <div class="work-bottom-box">
              <div class="image">
                <img src="/templates/esoft/img/work/work-prosses7-bottom3.png" alt="" />
              </div>
              <div class="shape3 shape-animaiton2">
                <img src="/templates/esoft/img/work/work-prosses7-bottom-shape3.png" alt="" />
              </div>
            </div>
          </div>
        </div>
    ...
    <!-- ===== SYSTEM AREA START ======= -->
    <div class="buy-sell sp" id="system" style="background-image: url(/templates/esoft/img/bg/system-bg.png);">
      <div class="container">
        <div class="row">
          <div class="col-lg-6 m-auto text-center">
          ...
          <div class="row align-items-center">
            ...
            <div class="col-lg-6">
              <div class="service1-main-images" data-aos="zoom-out" data-aos-duration="900">
                <div class="main-img1">
                  <img src="/templates/esoft/img/others/system-main-image1.png" alt="" />
                </div>

                <div class="main-img2 animate1">
                  <img src="/templates/esoft/img/others/system-main-image2.png" alt="" />
                </div>
    ...
    <div class="testimonial7 sp" id="tes">
      <div class="container">
        <div class="row">
          <div class="col-lg-6 m-auto text-center">
            <div class="heading7">
        ...
        <div class="row align-items-center">
          <div class="col-lg-5">
            <div class="main-image" data-aos="fade-up" data-aos-duration="700">
              <img src="/templates/esoft/img/testimonial/tes7-main-image.png" alt="" />
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-lg-6 m-auto text-center">
          <div class="cta-heading">
            ...
            <div class="buttons">
              <a href="#"><img src="/templates/esoft/img/icons/cta7-btn1.svg" alt="" /></a>
              <a href="#"><img src="/templates/esoft/img/icons/cta7-btn2.svg" alt="" /></a>
            </div>
          </div>
        </div>
      </div>
      <img src="/templates/esoft/img/others/cta7-image-shape1.png" alt="" class="image-shape1" />
      <img src="/templates/esoft/img/others/cta7-image-shape2.png" alt="" class="image-shape2" />
    </div>
  </div>
  <!-- ===== CTA AREA END ======= -->
