@extends('esoft.layouts.base', ['title' => 'Management Landing Page Software'])
...
@section('content')
  @include('esoft.layouts.partials.loader', ["isLight" => true])
  
  @include('esoft.layouts.partials.header-single.navbar7')

  <!-- ===== HERO AREA START ======= -->
  <div class="hero-area1" style="background-image: url(/templates/esoft/img/bg/hero1-bg.png);">
    <div class="container">
    <div class="row">
      <div class="col-lg-7 m-auto text-center">
      <div class="main-headding">
        <span class="span"><img src="/templates/esoft/img/shapes/headding1-span.png" alt="" /> Get everyone working in a single platform</span>
        <h1 class="pbmit-title">The Ultimate Of <span class="after">eSoft</span> Project Management</h1>
        ...
        <a href="{{ route('esoft.second', ['auth', 'account']) }}" class="btn btn--ripple ripple">Get Started For Free</a>
        <a href="{{ route('esoft.second', ['pages', 'features']) }}" class="btn btn2 btn--ripple ripple">Book A Demo</a>
      </div>
      </div>
    </div>
    </div>
  ...
  <div class="hero-area-image">
    ...
    <div class="row">
      ...
      <div class="images-area _relative">
        <div class="image">
        <img src="/templates/esoft/img/hero/hero1-image.png" alt="" />
        </div>
        <img src="/templates/esoft/img/shapes/hero1-img-shape.png" alt="" class="shape" />
      </div>
      </div>
    </div>
    </div>
  ...
  <div data-bs-spy="scroll" data-bs-target="#list-example" data-bs-offset="0" class="scrollspy-example" tabindex="0">
    <!-- ===== FEATURES AREA START ======= -->
    <div class="features sp _relative" id="features">
    <div class="container">
      <div class="row">
      <div class="col-lg-7 m-auto text-center">
        <div class="headding1">
        <span class="span" data-aos="fade-up" data-aos-duration="800"><img src="/templates/esoft/img/shapes/headding1-span.png" alt="" /> Get everyone working in a single platform</span>
          ...
          <div class="features-box">
            ...
            <div class="col-lg-7">
              ...
              <div class="bottom-headding-area">
                <div class="image">
                <img src="/templates/esoft/img/features/features-img1.png" alt="" />
                </div>
                <div class="">
                <ul class="stars">
                  <li>
            ...
            <div class="col-lg-5">
              ...
              <div class="features-sidebox">
                <ul>
                <li>
                  <img src="/templates/esoft/img/icons/features-icon1.png" alt="" /> Flexible workflows for any project
                </li>
                <li>
                  <img src="/templates/esoft/img/icons/features-icon2.png" alt="" /> Tasks, docs, spreadsheets, & more
                </li>
                <li>
                  <img src="/templates/esoft/img/icons/features-icon3.png" alt="" /> Resource and workload optimization
                </li>
                <li>
                  <img src="/templates/esoft/img/icons/features-icon4.png" alt="" /> Dashboards and insights
                </li>
                </ul>
              </div>
              <a href="{{ route('esoft.second', ['auth', 'account']) }}" class="btn btn--ripple ripple">Join Workspace With eSoft</a>
              </div>
            </div>
            </div>
          </div>
    ...
    <img class="shape1 shape-animaiton1" src="/templates/esoft/img/shapes/features-shape1.png" alt="" />
    <img class="shape2 shape-animaiton1" src="/templates/esoft/img/shapes/features-shape2.png" alt="" />
    </div>
    <!-- ===== FEATURES AREA END ======= -->

    <!-- ===== WORK PROSESS AREA START ======= -->
    <div class="work-prosess pb120 _relative" id="work" style="background-image: url(/templates/esoft/img/bg/work-prosess-bg.png); background-repeat: no-repeat; background-size: contain;">
    <div class="container">
      <div class="row">
      <div class="col-lg-7 m-auto text-center">
        <div class="headding1">
        <span class="span" data-aos="fade-up" data-aos-duration="800"><img src="/templates/esoft/img/shapes/headding1-span.png" alt="" /> Our Work prosess</span>
      ...
      <div class="col-lg-6">
        ...
        <div class="single-box" data-aos="zoom-in-up" data-aos-duration="800">
          ...
          <div class="space40"></div>
          <div class="image">
          <img src="/templates/esoft/img/work/work-prosess-img1.png" alt="" />
          </div>
        </div>
        </div>
      </div>
      ...
      <div class="col-lg-6">
        ...
        <div class="single-box" data-aos="zoom-in-up" data-aos-duration="1000">
          ...
          <div class="space40"></div>
          <div class="image">
          <img src="/templates/esoft/img/work/work-prosess-img2.png" alt="" />
          </div>
        </div>
        </div>
      </div>
      ...
      <div class="col-lg-4">
        ...
        <div class="single-box" data-aos="zoom-in-up" data-aos-duration="900">
          ...
          <div class="space40"></div>
          <div class="image">
          <img src="/templates/esoft/img/work/work-prosess-img3.png" alt="" />
          </div>
        </div>
        </div>
      </div>
      ...
      <div class="col-lg-4">
        ...
        <div class="single-box" data-aos="zoom-in-up" data-aos-duration="1200">
          ...
          <div class="space40"></div>
          <div class="image">
          <img src="/templates/esoft/img/work/work-prosess-img4.png" alt="" />
          </div>
        </div>
        </div>
      </div>
      ...
      <div class="col-lg-4">
        ...
        <div class="single-box" data-aos="zoom-in-up" data-aos-duration="1200">
          ...
          <div class="space40"></div>
          <div class="image">
          <img src="/templates/esoft/img/work/work-prosess-img5.png" alt="" />
          </div>
        </div>
        </div>
      </div>
    ...
    <!-- ===== TEAM AREA START ======= -->
    <div class="team-collaboration pb120" id="team">
    <div class="container">
      <div class="row align-items-center">
      <div class="col-lg-5">
        <div class="headding1">
        <span class="span" data-aos="fade-right" data-aos-duration="800"><img src="/templates/esoft/img/shapes/headding1-span.png" alt="" /> Team Collaboration</span>
        ...
        <div class="team-boxs" data-aos="fade-right" data-aos-duration="800">
          ...
          <div class="col-md-6">
            ...
            <div class="icon">
              <img src="/templates/esoft/img/icons/team-icon1.png" alt="" />
            </div>
            <div class="pera">
              <p>Project</p>
            </div>
          ...
          <div class="col-md-6">
            <div class="single-box">
            <div class="icon">
              <img src="/templates/esoft/img/icons/team-icon2.png" alt="" />
            </div>
            <div class="pera">
              <p>Invoice</p>
            </div>
          ...
          <div class="col-md-6">
            <div class="single-box">
            <div class="icon">
              <img src="/templates/esoft/img/icons/team-icon3.png" alt="" />
            </div>
            <div class="pera">
              <p>Proposals</p>
            </div>
          ...
          <div class="col-md-6">
            <div class="single-box">
            <div class="icon">
              <img src="/templates/esoft/img/icons/team-icon4.png" alt="" />
            </div>
            <div class="pera">
              <p>Forms</p>
            </div>
          ...
          <div class="col-md-6">
            <div class="single-box">
            <div class="icon">
              <img src="/templates/esoft/img/icons/team-icon5.png" alt="" />
            </div>
            <div class="pera">
              <p>Scheduler</p>
            </div>
          ...
          <div class="col-md-6">
            <div class="single-box">
            <div class="icon">
              <img src="/templates/esoft/img/icons/team-icon6.png" alt="" />
            </div>
            <div class="pera">
              <p>Inbox</p>
            </div>
      ...
      <div class="col-lg-7">
        ...
        <div class="image1" data-aos="zoom-out" data-aos-duration="900">
          <img src="/templates/esoft/img/team/team-img1.png" alt="" />
        </div>
        <div class="image2 shape-animaiton2" data-aos="flip-right" data-aos-duration="800">
          <img src="/templates/esoft/img/team/team-img2.png" alt="" />
        </div>
        </div>
      </div>
      </div>
      ...
      <div class="col-lg-12 text-center">
        ...
        <div class="cta-smoll-bg">
          ...
          <div class="buttons" data-aos="fade-up" data-aos-duration="1100">
            <a href="{{ route('esoft.second', ['auth', 'account']) }}" class="btn btn5 btn--ripple ripple">Get Started Now</a>
            <a href="{{ route('esoft.second', ['auth', 'account']) }}" class="btn btn3 btn--ripple ripple">14 Days Free Trials</a>
          </div>
          </div>
        </div>
        </div>
    ...
    <div class="container">
      ...
      <div class="col-lg-6 m-auto text-center">
        <div class="headding1">
        <span class="span" data-aos="fade-up" data-aos-duration="800"><img src="/templates/esoft/img/shapes/headding1-span.png" alt="" /> Team Collaboration</span>
        ...
        <h6 data-aos="fade-up" data-aos-duration="1100">Explore Our <a href="{{ route('esoft.second', ['pages', 'features']) }}" class="after">Integration Library</a></h6>
        </div>
      </div>
      </div>
      ...
      <div class="col-lg-12">
        ...
        <img src="/templates/esoft/img/logo/brands-logo.png" alt="" />
        </div>
      </div>
      </div>
    </div>
    <img class="brand-shape1 shape-animaiton2" src="/templates/esoft/img/shapes/brand-shape1.png" alt="" />
    <img class="brand-shape2 shape-animaiton1" src="/templates/esoft/img/shapes/brand-shape1.png" alt="" />
    <img class="brand-shape3" src="/templates/esoft/img/shapes/brand-shape1.png" alt="" />
    </div>
    <!-- ===== BRANS AREA END ======= -->

    <!-- ===== TESTIMONIAL AREA START ======= -->
    <div class="testimonial-area pb120" id="tes">
    <div class="container">
      <div class="row">
      <div class="col-lg-6 m-auto text-center">
        <div class="headding1">
        <span class="span" data-aos="fade-up" data-aos-duration="800"><img src="/templates/esoft/img/shapes/headding1-span.png" alt="" /> Client Testimonials</span>
      ...
      <div class="col-lg-12">
        ...
        <div class="testimonial-single-slider">
          ...
          <div class="single">
            <img src="/templates/esoft/img/logo/tes1-logo1.png" alt="" />
          </div>
          <div class="single">
            <img src="/templates/esoft/img/logo/tes1-logo2.png" alt="" />
          </div>
          <div class="single">
            <img src="/templates/esoft/img/logo/tes1-logo3.png" alt="" />
          </div>
          <div class="single">
            <img src="/templates/esoft/img/logo/tes1-logo4.png" alt="" />
          </div>
          <div class="single">
            <img src="/templates/esoft/img/logo/tes1-logo5.png" alt="" />
          </div>
          ...
          <div class="single-slider">
            ...
            <div class="col-lg-4">
              <div class="image">
              <img src="/templates/esoft/img/testimonial/tes1-big-img.png" alt="" />
              </div>
            </div>
            </div>
          </div>
    ...
    <!-- ===== BLOG AREA START ======= -->
    <div class="blog1 pb120" id="blog">
    <div class="container">
      <div class="row">
      <div class="col-lg-6 m-auto text-center">
        <div class="headding1">
        <span class="span" data-aos="fade-up" data-aos-duration="800"><img src="/templates/esoft/img/shapes/headding1-span.png" alt="" /> Our Blogs</span>
      ...
      <div class="col-lg-4 col-md-6">
        ...
        <div class="blog-image">
          <img src="/templates/esoft/img/blog/blog-img1.png" alt="" />
        </div>
        <div class="headding1">
          <a href="#" class="date"><img src="/templates/esoft/img/icons/date-icon.png" alt="" /> Mon Nov 01 2023</a>
          <h4><a href="{{ route('esoft.second', ['blogs', 'details']) }}">From Vision to Reality: Our Proven Project Management Approach</a></h4>
          <div class="space16"></div>
          <p>We begin by comprehensively understand your best project goals and requirements.</p>
          <div class="space16"></div>
          <a href="{{ route('esoft.second', ['blogs', 'details']) }}" class="learn">Learn more <span><i class="fa-regular fa-arrow-right"></i></span></a>
        </div>
        </div>
      </div>
      ...
      <div class="col-lg-4 col-md-6">
        ...
        <div class="blog-image">
          <img src="/templates/esoft/img/blog/blog-img2.png" alt="" />
        </div>
        <div class="headding1">
          <a href="#" class="date"><img src="/templates/esoft/img/icons/date-icon.png" alt="" /> Mon Nov 01 2023</a>
          <h4><a href="{{ route('esoft.second', ['blogs', 'details']) }}">From Vision to Reality: Our Proven Project Management Approach</a></h4>
      ...
      <div class="col-lg-4 col-md-6">
        ...
        <div class="blog-image">
          <img src="/templates/esoft/img/blog/blog-img3.png" alt="" />
        </div>
        <div class="headding1">
          <a href="#" class="date"><img src="/templates/esoft/img/icons/date-icon.png" alt="" /> Thu Dec 02 2023</a>
          <h4><a href="{{ route('esoft.second', ['blogs', 'details']) }}">Navigate Success: Empowering Projects Expert Management</a></h4>
          <div class="space16"></div>
          <p>We begin by comprehensively understand your best project goals and requirements.</p>
          <div class="space16"></div>
          <a href="{{ route('esoft.second', ['blogs', 'details']) }}" class="learn">Learn more <span><i class="fa-regular fa-arrow-right"></i></span></a>
  ...
  <!-- ===== CTA AREA START ======= -->
  <div class="cta1" style="background-image: url(/templates/esoft/img/bg/cta1-bg.png); background-position: center; background-size: cover; background-repeat: no-repeat;">
    <div class="container">
    <div class="row">
      <div class="col-lg-6 m-auto text-center">
      <div class="headding1">
        <div class="big-logo">
        <img src="/templates/esoft/img/logo/big-logo.png" alt="" />
        </div>
        <div class="space30"></div>
        ...
        <div class="space20"></div>
        <div class="buttons">
        <a href="{{ route('esoft.second', ['auth', 'account']) }}" class="btn btn3 btn--ripple ripple">Get started -free forever</a>
        <a href="#" class="btn btn2 btn--ripple ripple"><img src="/templates/esoft/img/icons/google.png" alt="" /> Sign up with google</a>
        </div>
      </div>
      </div>
    </div>
  ...
  <div class="footer1 _relative">
    ...
    <img class="footer-shape" src="/templates/esoft/img/shapes/footer-shape.png" alt="" />
  </div>
  <!-- ===== FOOTER AREA END ======= -->
@endsection