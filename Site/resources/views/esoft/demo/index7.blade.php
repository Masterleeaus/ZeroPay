...
@section('content')
  ...
  @include('esoft.layouts.partials.header.navbar7')
  ...
  <div class="work-prosess pb120 _relative" style="background-image: url(/templates/esoft/img/bg/work-prosess-bg.png); background-repeat: no-repeat; background-size: contain;">
    <div class="container">
      <div class="row">
        <div class="col-lg-7 m-auto text-center">
          <div class="headding1">
            ...
            <div class="cta-smoll-bg">
              <div class="headding1">
                ...
                <div class="buttons" data-aos="fade-up" data-aos-duration="1100">
                  <a href="{{ route('esoft.second', ['auth', 'account']) }}" class="btn btn2 btn--ripple ripple">Sign Up For Free</a>
                  <a href="{{ route('esoft.second', ['auth', 'account']) }}" class="btn btn3 btn--ripple ripple">Sign Up For Free</a>
                </div>
              </div>
            </div>
          </div>
                  ...
                  <div class="row">
                    <div class="col-lg-8">
                      ...
                      <div class="bottom-headding">
                        ...
                        <a class="ancor" href="{{ route('esoft.second', ['pages', 'testimonial']) }}">Read More Testimonials Feedback</a>
                      </div>
                    </div>
                    <div class="col-lg-4">
                      <div class="image">
      ...
      <div class="row">
        <div class="col-lg-6 m-auto text-center">
          <div class="headding1">
            ...
            <div class="buttons">
              <a href="{{ route('esoft.second', ['auth', 'account']) }}" class="btn btn3 btn--ripple ripple">Sign Up For Free</a>
              <a href="#" class="btn btn4 btn--ripple ripple"><img src="/templates/esoft/img/icons/google.png" alt="" /> Sign up with google</a>
            </div>
          </div>
        </div>
      </div>
