@extends('esoft.layouts.base' , [ 'title' => 'SEO Software Landing Page' , 'logo3' => true])
...
@section('content')
  ...
  @include('esoft.layouts.partials.header.navbar8')
  ...
  <!-- ===== STIKY AREA START ======= -->
  <div class="stiky-sec sp" style="background-image: url(/templates/esoft/img/bg/stiky-bg.png); background-position: center center; background-repeat: no-repeat; background-size: cover;">
    <div class="container">
      <div class="row">
        <div class="col-lg-6 m-auto text-center">
          <div class="headding3">
  ...
  <!-- ===== TES AREA START ======= -->
  <div class="tes3 sp" style="background-image: url(/templates/esoft/img/bg/tes3-bg.png); background-position: center center; background-repeat: no-repeat; background-size: cover;">
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-6">
          <div class="headding2">
