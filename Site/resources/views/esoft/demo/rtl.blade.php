@extends('esoft.layouts.base' , [ 'title' => 'HR Software Website' , 'logo5' => true])
...
@section('content')
  ...
  @include('esoft.layouts.partials.header.rtl-navbar')
      ...
      <div class="row align-items-center">
        <div class="col-lg-5">
          <div class="main-heading">
            <span class="span" data-aos="zoom-in-left" data-aos-duration="700"><img src="/templates/esoft/img/logo/span9.svg" alt="" /> Keep track of your employee data</span>
            <h1 data-aos="zoom-in-left" data-aos-duration="700">Effortless employee management for A growing businesses</h1>
        ...
        <div class="col-lg-7">
          <div class="main-images">
            <div class="image1">
              <img src="/templates/esoft/img/hero/hero9-img1.png" alt="" />
            </div>
            <div class="image2 shape-animaiton">
              <img src="/templates/esoft/img/hero/hero9-img2.png" alt="" />
            </div>
            <div class="image3 shape-animaiton2">
              <img src="/templates/esoft/img/hero/hero9-img3.png" alt="" />
            </div>
            <div class="image4 animate1">
              <img src="/templates/esoft/img/hero/hero9-img4.png" alt="" />
            </div>
            <div class="image5">
              <img src="/templates/esoft/img/hero/hero9-img5.png" alt="" />
            </div>
            <div class="main-img">
              <img src="/templates/esoft/img/hero/hero9-main.png" alt="" />
            </div>
          </div>
        </div>
      </div>
  ...
  <!-- ===== WORK AREA START ======= -->
  <div class="work2 _relative">
    <div class="container">
      <div class="row">
        <div class="col-lg-6 m-auto text-center">
          <div class="heading9">
            <span class="span" data-aos="zoom-in-left" data-aos-duration="700"><img src="/templates/esoft/img/logo/span9.svg" alt="" /> Keep track of your employee data</span>
            <h2 data-aos="zoom-in-left" data-aos-duration="800">HRMS Software Will Be Your Organization Data Warehouse</h2>
          </div>
        </div>
      </div>
  ...
  <div class="work-prosess9 sp _relative">
    <div class="container">
      <div class="row">
        <div class="col-lg-7 m-auto text-center">
          <div class="heading9">
            <span class="span" data-aos="zoom-in-left" data-aos-duration="700"><img src="/templates/esoft/img/logo/span9.svg" alt="" /> eSoft Workforce</span>
            <h2 data-aos="zoom-in-left" data-aos-duration="800">Empower Of HR Workforce</h2>
          </div>
        </div>
      </div>
        ...
        <div class="col-lg-6">
          <div class="work-box-area left-top">
            <div class="single-box" data-aos="zoom-in-up" data-aos-duration="800">
              ...
              <div class="space40"></div>
              <div class="image">
                <img src="/templates/esoft/img/work/work-prosses7-img1.png" alt="" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-6">
          <div class="work-box-area right-top">
            <div class="single-box" data-aos="zoom-in-up" data-aos-duration="1000">
              ...
              <div class="space40"></div>
              <div class="image">
                <img src="/templates/esoft/img/work/work-prosses7-img2.png" alt="" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4">
          <div class="work-box-area right-top">
            <div class="single-box" data-aos="zoom-in-up" data-aos-duration="900">
              ...
              <div class="space40"></div>
              <div class="image">
                <img src="/templates/esoft/img/work/work-prosses7-img3.png" alt="" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4">
          <div class="work-box-area left-bottom">
            <div class="single-box" data-aos="zoom-in-up" data-aos-duration="1200">
              ...
              <div class="space40"></div>
              <div class="image">
                <img src="/templates/esoft/img/work/work-prosses7-img4.png" alt="" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4">
          <div class="work-box-area right-bottom">
            <div class="single-box" data-aos="zoom-in-up" data-aos-duration="1200">
              ...
              <div class="space40"></div>
              <div class="image">
                <img src="/templates/esoft/img/work/work-prosses7-img5.png" alt="" />
              </div>
            </div>
          </div>
        </div>
  ...
  <!-- ===== SYSTEM AREA START ======= -->
  <div class="buy-sell-bottom2">
    <div class="container">
      <div class="row">
        <div class="col-lg-6 m-auto text-center">
          <div class="heading9">
            <span class="span" data-aos="zoom-in-left" data-aos-duration="700"><img src="/templates/esoft/img/logo/span9.svg" alt="" /> eSoft Benefits</span>
            <h2 data-aos="zoom-in-left" data-aos-duration="700">eSoft HR Use Of Benefits</h2>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row align-items-center">
          <div class="col-lg-3">
            <div class="box-area-all" data-aos="flip-right" data-aos-duration="900">
              <div class="icon">
                <img src="/templates/esoft/img/icons/system-icon1.svg" alt="" />
              </div>
            ...
            <div class="box-area-all box-area-all2" data-aos="flip-right" data-aos-duration="900">
              <div class="icon">
                <img src="/templates/esoft/img/icons/system-icon2.svg" alt="" />
              </div>
              <div class="single-box heading7">
          ...
          <div class="col-lg-6">
            <div class="service1-main-images" data-aos="zoom-out" data-aos-duration="900">
              <div class="main-img1">
                <img src="/templates/esoft/img/others/system9-img1.png" alt="" />
              </div>

              <div class="main-img2 animate1">
                <img src="/templates/esoft/img/others/system9-img2.png" alt="" />
              </div>

              <div class="shape1">
                <img src="/templates/esoft/img/shapes/system-shape1.png" alt="" />
              </div>

              <div class="shape2">
                <img src="/templates/esoft/img/shapes/system-shape2.png" alt="" />
              </div>

              <div class="shape3">
                <img src="/templates/esoft/img/shapes/system-shape3.png" alt="" />
              </div>

              <div class="shape4">
                <img src="/templates/esoft/img/shapes/system-shape4.png" alt="" />
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-3">
            <div class="box-area-all box-area-all3" data-aos="flip-right" data-aos-duration="900">
              <div class="icon">
                <img src="/templates/esoft/img/icons/system-icon3.svg" alt="" />
              </div>
              <div class="single-box heading7">
            ...
            <div class="box-area-all box-area-all4" data-aos="flip-right" data-aos-duration="900">
              <div class="icon">
                <img src="/templates/esoft/img/icons/system-icon4.svg" alt="" />
              </div>
              <div class="single-box heading7">
  ...
  <div class="hr-solutions">
    <div class="container">
      <div class="row">
        <div class="col-lg-7">
          <div class="image">
            <img src="/templates/esoft/img/others/hr-solution-img.png" alt="" />
          </div>
        </div>
        <div class="col-lg-5">
          <div class="heading9">
            <span class="span" data-aos="zoom-in-left" data-aos-duration="700"><img src="/templates/esoft/img/logo/span9.svg" alt="" /> HR Solution</span>
            <h2 data-aos="zoom-in-left" data-aos-duration="700">Powerful Features For Effective HR Solutions</h2>
            <div class="space16"></div>
    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-6 text-center m-auto">
          <div class="heading9">
            <span class="span" data-aos="zoom-in-left" data-aos-duration="700"><img src="/templates/esoft/img/logo/span9.svg" alt="" /> Testimonials</span>
            <h2 data-aos="zoom-in-left" data-aos-duration="700">Why Our Users Love Us</h2>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="tes2-slider-all-rtl" data-aos="fade-up" data-aos-duration="900">
  ...
  <!-- ===== CTA AREA END ======= -->
  <div class="cta2-area" style="background-image: url(/templates/esoft/img/bg/cta2-bg.png); background-position: center; background-repeat: no-repeat; background-size: cover;">
    <div class="container">
      <div class="row">
        <div class="col-lg-6 m-auto text-center">
          <div class="headding2-w pbmit-heading-subheading animation-style2">
            <h2 data-aos="zoom-in-left" data-aos-duration="700">Join 500,000+ SEO's Who Trust eSoft For Insights That Help Their Business Grow.</h2>
            <div class="space16"></div>
            ...
            <div class="" data-aos="fade-up" data-aos-duration="1000">
              <a href="{{ route('esoft.second', ['auth', 'account']) }}" class="theme-btn3">Get Started For Free</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="cta2-images">
            <div class="img1">
              <img src="/templates/esoft/img/others/cta2-main-img.png" alt="" />
            </div>
            <div class="shape1">
              <img src="/templates/esoft/img/shapes/cta2-shape2.png" alt="" />
            </div>
            <div class="shape2">
              <img src="/templates/esoft/img/shapes/cta2-shape1.png" alt="" />
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="footer2 _relative">
    ...
    <img class="footer-shape" src="/templates/esoft/img/shapes/footer2-shape.png" alt="" />
    <img class="footer-shape2" src="/templates/esoft/img/shapes/footer2-shape2.png" alt="" />
  </div>
  <!-- ===== FOOTER AREA END ======= -->
@endsection
