...
@section('content')
  ...
  @include('esoft.layouts.partials.header.navbar3')
        ...
        <div class="col-lg-5">
          <div class="main-heading">
            ...
            <div class="buttons" data-aos="fade-left" data-aos-duration="1100">
              <a href="{{ route('esoft.second', ['auth', 'account']) }}" class="theme-btn10">Get Started Now <span class="arrow"><i class="fa-solid fa-arrow-right"></i></span></a>
  ...
  <!-- ===== SYSTEM AREA START ======= -->
  <div class="buy-sell sp" style="background-image: url(/templates/esoft/img/bg/system-bg.png);">
    <div class="container">
      <div class="row">
        <div class="col-lg-6 m-auto text-center">
