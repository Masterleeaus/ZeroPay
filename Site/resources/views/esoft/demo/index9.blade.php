@extends('esoft.layouts.base' , [ 'title' => 'Social Media Management & Schedule'])
...
@section('content')
  ...
  @include('esoft.layouts.partials.header.navbar9')

  <!-- ===== HERO AREA START ======= -->
  <div class="hero-area4" style="background-image: url(/templates/esoft/img/bg/header4-bg.png); background-repeat: no-repeat; background-size: cover; background-position: bottom center;">
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-7 m-auto text-center">
          <div class="main-headding pbmit-heading-subheading animation-style2">
            <span class="span"><img src="/templates/esoft/img/icons/span4-icon.png" alt="" /> Create Social Media Content. Faster.</span>
            <h1 class="text-anime-style-3">Social Media Management And Scheduling Refined</h1>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="hero4-images-all">
            <div class="image1">
              <img src="/templates/esoft/img/hero/hero4-img1.png" alt="" />
            </div>
            <div class="image2">
              <img src="/templates/esoft/img/hero/hero4-img2.png" alt="" />
            </div>
            <div class="image3 shape-animaiton3">
              <img src="/templates/esoft/img/hero/hero4-img3.png" alt="" />
            </div>
            <div class="image4 shape-animaiton3">
              <img src="/templates/esoft/img/hero/hero4-img4.png" alt="" />
            </div>
            <div class="image5 shape-animaiton2">
              <img src="/templates/esoft/img/hero/hero4-img5.png" alt="" />
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="service4 sp _relative">
      ...
      <div class="row">
        <div class="col-lg-4 col-md-6">
          <div class="" data-aos="zoom-in-up" data-aos-duration="800">
            <div class="service-box">
              <div class="icon">
                <img src="/templates/esoft/img/icons/service4-icon1.png" alt="" />
              </div>
              <div class="headding4">
                <h4><a href="{{ route('esoft.second', ['pages', 'features']) }}">Social Media Scheduling</a></h4>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="" data-aos="zoom-in-up" data-aos-duration="1000">
            <div class="service-box">
              <div class="icon">
                <img src="/templates/esoft/img/icons/service4-icon2.png" alt="" />
              </div>
              <div class="headding4">
                <h4><a href="{{ route('esoft.second', ['pages', 'features']) }}">Social Media Automation</a></h4>
                <div class="space16"></div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="" data-aos="zoom-in-up" data-aos-duration="1100">
            <div class="service-box">
              <div class="icon">
                <img src="/templates/esoft/img/icons/service4-icon4.png" alt="" />
              </div>
              <div class="headding4">
                <h4><a href="{{ route('esoft.second', ['pages', 'features']) }}">Social Media Management</a></h4>
                <div class="space16"></div>
    ...
    <img class="shape1" src="/templates/esoft/img/shapes/home4-shape1.png" alt="" />
  </div>
  <!-- ===== SERVICE AREA END ======= -->
      ...
      <div class="row">
        <div class="col-lg-7 m-auto text-center">
          <div class="headding4 pbmit-heading-subheading animation-style2">
            ...
            <h2 class="text-anime-style-3">Social Media Marketing With eSoft</h2>
            <div class="space16"></div>
          ...
          <div class="work5-tabs-all" data-aos="fade-up" data-aos-duration="1000">
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
              <li class="nav-item" role="presentation">
                <button class="nav-link active" id="work-items1-tab" data-bs-toggle="pill" data-bs-target="#work-items1" type="button" role="tab" aria-controls="work-items1" aria-selected="true"><span><img src="/templates/esoft/img/icons/work5-icon1.png" alt="" /></span> Collection</button>
              </li>
              <li class="nav-item" role="presentation">
                <button class="nav-link" id="work-items2-tab" data-bs-toggle="pill" data-bs-target="#work-items2" type="button" role="tab" aria-controls="work-items2" aria-selected="false"><span><img src="/templates/esoft/img/icons/work5-icon2.png" alt="" /></span> Scheduling</button>
              </li>
              <li class="nav-item" role="presentation">
                <button class="nav-link" id="work-items3-tab" data-bs-toggle="pill" data-bs-target="#work-items3" type="button" role="tab" aria-controls="work-items3" aria-selected="false"><span><img src="/templates/esoft/img/icons/work5-icon3.png" alt="" /></span> Automation</button>
              </li>
              <li class="nav-item" role="presentation">
                <button class="nav-link" id="work-items4-tab" data-bs-toggle="pill" data-bs-target="#work-items4" type="button" role="tab" aria-controls="work-items4" aria-selected="false"><span><img src="/templates/esoft/img/icons/work5-icon4.png" alt="" /></span> Reviews</button>
              </li>
            </ul>
                    ...
                    <div class="col-lg-6">
                      <div class="headding4">
                        ...
                        <div class="media-all">
                          ...
                          <div class="space30"></div>
                          <a href="{{ route('esoft.second', ['auth', 'account']) }}" class="theme-btn5">Start 14-Day Free Trail</a>
                        </div>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="work4-images">
                        <div class="image1">
                          <img src="/templates/esoft/img/work/work4-img1.png" alt="" />
                        </div>
                        <div class="image2">
                          <img src="/templates/esoft/img/work/work4-img2.png" alt="" />
                        </div>
                      </div>
                    </div>
                  </div>
  ...
  <!-- ===== POST AREA START ======= -->
  <div class="post-area sp _relative">
    <div class="container">
      <div class="row">
        <div class="col-lg-5 m-auto text-center">
          <div class="headding4 pbmit-heading-subheading animation-style2">
            <span class="span">Schedule Post</span>
            <h2 class="text-anime-style-3">Any Schedule Post?</h2>
            <div class="space16"></div>
      ...
      <div class="row align-items-center">
        <div class="col-lg-5">
          <div class="post-left-area">
            <div class="image1" data-aos="zoom-out" data-aos-duration="800">
              <img src="/templates/esoft/img/blog/post-image1.png" alt="" />
            </div>
            <div class="image2" data-aos="flip-right" data-aos-duration="1000">
              <img src="/templates/esoft/img/blog/post-image2.png" alt="" />
            </div>
            <div class="image3">
              <img src="/templates/esoft/img/shapes/post-shape.png" alt="" />
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-7">
          <div class="big-img">
            <img src="/templates/esoft/img/blog/post-rihgt-area-img.png" alt="" />
          </div>
        </div>
      </div>
    </div>

    <img class="shape1" src="/templates/esoft/img/shapes/home4-shape2.png" alt="" />
  </div>
  <!-- ===== POST AREA END ======= -->

  <!-- ===== MIDEA AREA START ======= -->
  <div class="midea-markating sp">
    <div class="container">
      <div class="row">
        <div class="col-lg-5 m-auto text-center">
          <div class="headding4 pbmit-heading-subheading animation-style2">
            <span class="span">Social Media Marketing</span>
            <h2 class="text-anime-style-3">What Do You Get From Social Media Marketing</h2>
          </div>
        </div>
      </div>
      <div class="space60"></div>
      <div class="row align-items-center">
        <div class="col-lg-6">
          <div class="image" data-aos="flip-right" data-aos-duration="900">
            <img src="/templates/esoft/img/others/media-marketing-img.png" alt="" />
          </div>
        </div>
          ...
          <div class="media-box-all">
            <div class="" data-aos-duration="900" data-aos="fade-left">
              <div class="single-box">
                <div class="icon">
                  <img src="/templates/esoft/img/icons/media-icon1.png" alt="" />
                </div>
                <div class="headding4">
            ...
            <div class="" data-aos-duration="1000" data-aos="fade-left">
              <div class="single-box">
                <div class="icon">
                  <img src="/templates/esoft/img/icons/media-icon2.png" alt="" />
                </div>
                <div class="headding4">
                  <h4><a href="#">Automate Your Work</a></h4>
                  <div class="space10"></div>
            ...
            <div class="" data-aos-duration="1100" data-aos="fade-left">
              <div class="single-box">
                <div class="icon">
                  <img src="/templates/esoft/img/icons/media-icon3.png" alt="" />
                </div>
                <div class="headding4">
  ...
  <div class="integration sp _relative">
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-6">
          <div class="headding4 pbmit-heading-subheading animation-style2">
            <span class="span">Our Integration</span>
            <h2 class="text-anime-style-3">Connect Entire Workflows</h2>
            <div class="space16"></div>
            ...
            <div class="" data-aos="fade-right" data-aos-duration="1000">
              <a href="{{ route('esoft.second', ['auth', 'account']) }}" class="theme-btn5">Browse All Integration</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-6">
          <div class="apps" data-aos="zoom-in-up" data-aos-duration="700">
            <img src="/templates/esoft/img/others/home4-apps.png" alt="" />
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="single-slider">
              <div class="row">
                <div class="col-lg-12">
                  ...
                  <img src="/templates/esoft/img/icons/tes4-icon.png" alt="" class="icon" />
                  <div class="bottom-headding">
                    <div class="image">
                      <img src="/templates/esoft/img/testimonial/tes4-img.png" alt="" />
                    </div>
                    <div class="headding">
        ...
        <div class="col-lg-8 m-auto text-center">
          ...
          <div class="tes4-logo-slider1">
            <div class="single-logo">
              <img src="/templates/esoft/img/logo/teas4-logo1.png" alt="" />
            </div>
            <div class="single-logo">
              <img src="/templates/esoft/img/logo/teas4-logo2.png" alt="" />
            </div>
            <div class="single-logo">
              <img src="/templates/esoft/img/logo/teas4-logo3.png" alt="" />
            </div>
            <div class="single-logo">
              <img src="/templates/esoft/img/logo/teas4-logo4.png" alt="" />
            </div>
            <div class="single-logo">
              <img src="/templates/esoft/img/logo/teas4-logo5.png" alt="" />
            </div>
            <div class="single-logo">
              <img src="/templates/esoft/img/logo/teas4-logo1.png" alt="" />
            </div>
          ...
          <div class="tes4-logo-slider2">
            <div class="single-logo">
              <img src="/templates/esoft/img/logo/tes2-slider2-logo1.png" alt="" />
            </div>
            <div class="single-logo">
              <img src="/templates/esoft/img/logo/tes2-slider2-logo2.png" alt="" />
            </div>
            <div class="single-logo">
              <img src="/templates/esoft/img/logo/tes2-slider2-logo3.png" alt="" />
            </div>
            <div class="single-logo">
              <img src="/templates/esoft/img/logo/tes2-slider2-logo4.png" alt="" />
            </div>
            <div class="single-logo">
              <img src="/templates/esoft/img/logo/tes2-slider2-logo5.png" alt="" />
            </div>
            <div class="single-logo">
              <img src="/templates/esoft/img/logo/tes2-slider2-logo1.png" alt="" />
            </div>
  ...
  <!-- ===== BLOG AREA START ======= -->
  <div class="blog4 sp _relative">
    <div class="container">
      <div class="row">
        <div class="col-lg-6 m-auto text-center">
          <div class="headding4 pbmit-heading-subheading animation-style2">
            <span class="span">Our Blog</span>
            <h2 class="text-anime-style-3">Our Latest Articles & Blog</h2>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-lg-4 col-md-6">
          <div class="blog4-single-box" data-aos="zoom-in-up" data-aos-duration="800">
            <div class="image">
              <img src="/templates/esoft/img/blog/blog4-img1.png" alt="" />
            </div>
            <div class="headding4">
              <a href="#" class="date"><img src="/templates/esoft/img/icons/date-icon4.png" alt="" /> 10 October 2023</a>
              <h5><a href="{{ route('esoft.second', ['blogs', 'details']) }}">The Ultimate Guide Social Media Manage & Scheduling Success</a></h5>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="blog4-single-box" data-aos="zoom-in-up" data-aos-duration="1000">
            <div class="image">
              <img src="/templates/esoft/img/blog/blog4-img2.png" alt="" />
            </div>
            <div class="headding4">
              <a href="#" class="date"><img src="/templates/esoft/img/icons/date-icon4.png" alt="" /> 24 April 2023</a>
              <h5><a href="{{ route('esoft.second', ['blogs', 'details']) }}">The ROI of Streamlining with Social Media World Management</a></h5>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="blog4-single-box" data-aos="zoom-in-up" data-aos-duration="1200">
            ...
            <div class="headding4">
              <a href="#" class="date"><img src="/templates/esoft/img/icons/date-icon4.png" alt="" /> 10 August 2023</a>
              <h5><a href="{{ route('esoft.second', ['blogs', 'details']) }}">The Hidden Best Benefits of Social Media Scheduling for Businesses</a></h5>
  ...
  <!-- ===== CTA AREA START ======= -->
  <div class="cta4" style="background-image: url(/templates/esoft/img/bg/cta4-bg.png); background-position: bottom center; background-repeat: no-repeat; background-size: cover;">
    <div class="container">
      <div class="row">
        <div class="col-lg-7 m-auto text-center">
          <div class="headding4-w">
            <h2>Join The Revolution! Schedule Your Way To Social Media Excellence</h2>
            <p data-aos="fade-up" data-aos-duration="800">Welcome to the digital era's command centre for your online presence! At eSoft, redefine the landscape of social media management and scheduling, offering you a seamless.</p>
            ...
            <div class="buttons" data-aos="fade-up" data-aos-duration="1000">
              ...
              <a href="{{ route('esoft.second', ['auth', 'account']) }}" class="theme-btn6">Start 14-Day Free Trail</a>
            </div>
          </div>
        </div>
      </div>
