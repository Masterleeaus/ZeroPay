@extends('esoft.layouts.base' , [ 'title' => 'Time Tracker' , 'logo5' => true])
...
@section('content')
  ...
  @include('esoft.layouts.partials.header.navbar2')
        ...
        <div class="row">
          <div class="col-lg-7 m-auto text-center">
            <div class="main-heading">
              <span class="span" data-aos="zoom-in-left" data-aos-duration="700"><img src="/templates/esoft/img/icons/main-span5.png" alt="" /> No 01 Time Tracker Software on Producthunt</span>
              ...
              <div class="buttons" data-aos="fade-up" data-aos-duration="900">
                <a href="{{ route('esoft.second', ['auth', 'account']) }}" class="theme-btn7"><span class="arrow"><img src="/templates/esoft/img/icons/home5-btn-icon1.svg" alt="" /></span> Get Started, It’s Free</a>
                <a href="{{ route('esoft.second', ['pages', 'features']) }}" class="theme-btn7"><span class="arrow"><img src="/templates/esoft/img/icons/home5-btn-icon1.svg" alt="" /></span> Get a Demo</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="main-image">
              <img src="/templates/esoft/img/hero/hero5-main-image.png" alt="" />
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="hero5-slider-hading">
            ...
            <div class="hero5-slider-all">
              <div class="single-slider">
                <img src="/templates/esoft/img/logo/hero5-slider1.png" alt="" />
              </div>
              <div class="single-slider">
                <img src="/templates/esoft/img/logo/hero5-slider2.png" alt="" />
              </div>
              <div class="single-slider">
                <img src="/templates/esoft/img/logo/hero5-slider3.png" alt="" />
              </div>
              <div class="single-slider">
                <img src="/templates/esoft/img/logo/hero5-slider4.png" alt="" />
              </div>
              <div class="single-slider">
                <img src="/templates/esoft/img/logo/hero5-slider5.png" alt="" />
              </div>
              <div class="single-slider">
                <img src="/templates/esoft/img/logo/hero5-slider1.png" alt="" />
              </div>
        ...
        <div class="col-lg-7 m-auto text-center">
          <div class="heading5">
            <p class="title" data-aos="zoom-in-left" data-aos-duration="700">
              <span class="span"><img src="/templates/esoft/img/icons/heading5-span.png" alt="" /> Why Choose eSoft?</span>
            </p>
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="choose-box" data-aos="zoom-in-up" data-aos-duration="700">
            <div class="image">
              <img src="/templates/esoft/img/choose/choose5-img1.png" alt="" />
            </div>
        ...
        <div class="col-lg-4">
          <div class="choose-box" data-aos="zoom-in-up" data-aos-duration="900">
            <div class="image">
              <img src="/templates/esoft/img/choose/choose5-img2.png" alt="" />
            </div>
            <div class="space20"></div>
            <div class="heading5">
        ...
        <div class="col-lg-4">
          <div class="choose-box" data-aos="zoom-in-up" data-aos-duration="1100">
            <div class="image">
              <img src="/templates/esoft/img/choose/choose5-img3.png" alt="" />
            </div>
            <div class="space20"></div>
            <div class="heading5">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-7">
            <div class="main-image" data-aos="zoom-out" data-aos-duration="800">
              <img src="/templates/esoft/img/others/time-track-sec-main.png" alt="" />
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="service5 sp">
    <div class="container">
      <div class="row">
        <div class="col-lg-6 m-auto text-center">
          <div class="heading5">
            <p class="title" data-aos="zoom-in-left" data-aos-duration="700">
              <span class="span"><img src="/templates/esoft/img/icons/heading5-span.png" alt="" /> Choose by Industry</span>
            </p>
            ...
            <div class="tabs-boxs">
              <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                <li class="nav-item" role="presentation" data-aos="fade-up" data-aos-duration="800">
                  <button class="nav-link active" id="service-items1-tab" data-bs-toggle="pill" data-bs-target="#service-items1" type="button" role="tab" aria-controls="service-items1" aria-selected="true"><img src="/templates/esoft/img/icons/service5-icon1.svg" alt="" /> <br /> <span>SEO</span></button>
                </li>
                <li class="nav-item" role="presentation" data-aos="fade-up" data-aos-duration="1000">
                  <button class="nav-link" id="service-items2-tab" data-bs-toggle="pill" data-bs-target="#service-items2" type="button" role="tab" aria-controls="service-items2" aria-selected="false"><img src="/templates/esoft/img/icons/service5-icon2.svg" alt="" /> <br /> <span>Content Marketing</span></button>
                </li>
                <li class="nav-item" role="presentation" data-aos="fade-up" data-aos-duration="900">
                  <button class="nav-link" id="service-items3-tab" data-bs-toggle="pill" data-bs-target="#service-items3" type="button" role="tab" aria-controls="service-items3" aria-selected="false"><img src="/templates/esoft/img/icons/service5-icon3.svg" alt="" /> <br /> <span>Market Research</span></button>
                </li>
                <li class="nav-item" role="presentation" data-aos="fade-up" data-aos-duration="1100">
                  <button class="nav-link" id="service-items4-tab" data-bs-toggle="pill" data-bs-target="#service-items4" type="button" role="tab" aria-controls="service-items4" aria-selected="false"><img src="/templates/esoft/img/icons/service5-icon4.svg" alt="" /> <br /> <span>Advertising</span></button>
                </li>
                <li class="nav-item" role="presentation" data-aos="fade-up" data-aos-duration="900">
                  <button class="nav-link" id="service-items5-tab" data-bs-toggle="pill" data-bs-target="#service-items5" type="button" role="tab" aria-controls="service-items5" aria-selected="false"><img src="/templates/esoft/img/icons/service5-icon5.svg" alt="" /> <br /> <span>Social Media</span></button>
                </li>
              </ul>
            </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6">
                        <div class="tab-bottom-images">
                          <div class="img1">
                            <img src="/templates/esoft/img/others/tab5-img1.png" alt="" />
                          </div>
                          <div class="img2 shape-animaiton3">
                            <img src="/templates/esoft/img/others/tab5-img2.png" alt="" />
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="col-lg-6">
                        <div class="tab-bottom-headding">
                          <div class="heading5">
                            ...
                            <div class="space30"></div>
                            <a href="#" class="theme-btn7"><span class="arrow"><img src="/templates/esoft/img/icons/home5-btn-icon1.svg" alt="" /></span> Get Started, It’s Free</a>
                          </div>
                        </div>
                      </div>
    ...
    <img src="/templates/esoft/img/shapes/faq5-shape1.png" alt="" class="shape1" />
    <img src="/templates/esoft/img/shapes/faq5-shape2.png" alt="" class="shape2" />
  </div>
  <!-- ===== SERVICE AREA END ======= -->

  <!-- ===== APPS AREA START ======= -->
  <div class="apps5-area sp">
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-6">
          <div class="apps-image" data-aos="flip-right" data-aos-duration="800">
            <img src="/templates/esoft/img/others/apps-img5.png" alt="" />
          </div>
        </div>
        <div class="col-lg-6">
          <div class="heading5">
            <p class="title" data-aos="zoom-in-left" data-aos-duration="700">
              <span class="span"><img src="/templates/esoft/img/icons/heading5-span.png" alt="" /> Intregrations</span>
            </p>
  ...
  <!-- ===== PRICING AREA START ======= -->
  <div class="pricing5 pb100">
    <div class="container">
      <div class="row">
        <div class="col-lg-6 m-auto text-center">
          <div class="heading5">
            <p class="title" data-aos="zoom-in-left" data-aos-duration="700">
              <span class="span"><img src="/templates/esoft/img/icons/heading5-span.png" alt="" /> Pricing Plan</span>
            </p>
            ...
            <div class="row">
              <div class="col-md-5">
                <div class="heading5">
                  ...
                  <div class="space30"></div>
                  <a href="#" class="theme-btn7"><span class="arrow"><img src="/templates/esoft/img/icons/home5-btn-icon1.svg" alt="" /></span> Get Started</a>
                </div>
              </div>
              <div class="col-md-7">
                <ul class="plan-list">
    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-6 text-center m-auto">
          <div class="heading5">
            <p class="title" data-aos="zoom-in-left" data-aos-duration="700">
              <span class="span"><img src="/templates/esoft/img/icons/heading5-span.png" alt="" /> Testimonials</span>
            </p>
        ...
        <div class="col-lg-12">
          <div class="tes2-slider-all" data-aos="fade-up" data-aos-duration="900">
            <div class="single-slider">
              ...
              <div class="icon">
                <img src="/templates/esoft/img/icons/qute5.svg" alt="" />
              </div>
  ...
  <!-- ===== BLOG AREA START ======= -->
  <div class="blog2 blog5 sp">
    <div class="container">
      <div class="row">
        <div class="col-lg-6 m-auto text-center">
          <div class="heading5">
            <p class="title" data-aos="zoom-in-left" data-aos-duration="700">
              <span class="span"><img src="/templates/esoft/img/icons/heading5-span.png" alt="" /> Our Blog</span>
            </p>
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="blog-box" data-aos="zoom-in-up" data-aos-duration="800">
            <div class="image">
              <img src="/templates/esoft/img/blog/blog5-img1.png" alt="" />
            </div>
            <div class="headding">
              <div class="tags">
        ...
        <div class="col-lg-6">
          <div class="blog-box" data-aos="zoom-in-up" data-aos-duration="1000">
            <div class="image">
              <img src="/templates/esoft/img/blog/blog5-img2.png" alt="" />
            </div>
            <div class="headding">
              <div class="tags">
                <a href="#"><img src="/templates/esoft/img/icons/blog2-icon1.png" alt="" /> 10 October 2023</a>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 m-auto text-center">
          <div class="heading5">
            <p class="title" data-aos="zoom-in-left" data-aos-duration="700">
              <span class="span"><img src="/templates/esoft/img/icons/heading5-span.png" alt="" /> FAQ</span>
            </p>
        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="heading5-w">
              ...
              <div class="space30"></div>
              <a href="{{ route('esoft.second', ['auth', 'account']) }}" class="theme-btn7"><span class="arrow"><img src="/templates/esoft/img/icons/home5-btn-icon1.svg" alt="" /></span> Sign Up Now</a>
            </div>
          </div>
          <div class="col-lg-6">
            <div class="main-image">
              <img src="/templates/esoft/img/others/cta5-main-img.png" alt="" />
            </div>
          </div>
        </div>
      </div>
