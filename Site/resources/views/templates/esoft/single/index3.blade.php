@extends('templates.esoft.layouts.base' , [ 'title' => 'POS Software' , 'logo5' => true])
...
@section('content')
  ...
  @include('templates.esoft.layouts.partials.header-single.navbar3')
  ...
  <div data-bs-spy="scroll" data-bs-target="#list-example" data-bs-offset="0" class="scrollspy-example" tabindex="0">
    ...
    <!-- ===== SYSTEM AREA START ======= -->
    <div class="buy-sell sp" id="system" style="background-image: url(/img/bg/system-bg.png);">
      <div class="container">
        <div class="row">
          <div class="col-lg-6 m-auto text-center">
