...
class MoneyOutController extends Controller
{
   ...
   public function paymentInsert(Request $request){
        ...
        //daily and monthly
        try{
            (new TransactionLimit())->trxLimit('merchant_id',$userWallet->merchant->id,PaymentGatewayConst::TYPEMONEYOUT,$userWallet->currency,$amount, $gate,PaymentGatewayConst::SEND);
        }catch(Exception $e){
