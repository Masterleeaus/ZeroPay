...
class StripeVirtualController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->stripe_supported_currencies = [
            ...
            "countries" => [
                "United States","United Kingdom", "United Arab Emirates", "Afghanistan", "Albania", "Armenia", "Angola", "Argentina", "Australia", "Aruba",
                "Azerbaijan", "Bosnia and Herzegovina", "Barbados", "Bangladesh", "Bulgaria",
                "Burundi", "Bermuda", "Brunei", "Bolivia", "Brazil", "Bahamas", "Botswana",
                "Belarus", "Belize", "Canada", "Congo", "Switzerland", "Chile", "China",
                "Nigeria", "Nicaragua", "Norway", "Nepal", "New Zealand", "Panama",
                "Peru", "Papua New Guinea", "Philippines", "Pakistan", "Poland", "Paraguay",
                "Qatar", "Romania", "Serbia", "Russia", "Rwanda", "Saudi Arabia", "Solomon Islands",
                "Seychelles", "Sweden", "Singapore", "Saint Helena", "Somalia",
                "Suriname", "Sao Tome and Principe", "Thailand", "Tajikistan",
                "Tonga", "Turkey", "Trinidad and Tobago", "Taiwan", "Tanzania", "Ukraine",
                "Uganda", "Uruguay", "Uzbekistan", "Vietnam", "Vanuatu", "Samoa", "Central African Republic",
                "Cote D'Ivoire (Ivory Coast)", "Yemen", "South Africa",
                "Zambia"
            ]
        ];
    }
    public function index()
    {
        ...
        $transactions = Transaction::auth()->virtualCard()->latest()->take(10)->get()->map(function($item){
            ...
            return[
                ...
                'card_amount' => getAmount(@$item->details->card_info->amount, get_wallet_precision()).' '.$item->details->card_info->currency ?? get_default_currency_code(),
