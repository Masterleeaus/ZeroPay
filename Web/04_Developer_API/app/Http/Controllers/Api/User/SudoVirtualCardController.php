...
class SudoVirtualCardController extends Controller
{
    ...
    public function index()
    {
        ...
        $myCards = SudoVirtualCard::where('user_id',$user->id)->latest()->limit($this->card_limit)->get()->map(function($data){
            ...
            return[
                ...
                'amount' => getAmount(updateSudoCardBalance(auth()->user(),$data->card_id,$live_card_data), get_wallet_precision()),
        ...
        $supported_currency = support_currencies(['USD','NGN'],['United States','Nigeria']);
    ...
    public function cardBuy(Request $request)
    {
        ...
        if(get_amount($amount, null,get_wallet_precision()) < get_amount($minLimit, null,get_wallet_precision()) || get_amount($amount, null,get_wallet_precision()) > get_amount($maxLimit, null,get_wallet_precision())) {
