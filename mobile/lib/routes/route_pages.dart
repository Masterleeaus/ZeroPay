...
import 'package:zeropay/views/auth/kyc_from/wait_for_approval_screen.dart';
import 'package:zeropay/views/auth/login/otp_verification_screen.dart';
import 'package:zeropay/views/auth/registration/email_otp_screen.dart';
import 'package:zeropay/views/auth/registration/registration_screen.dart';
import 'package:zeropay/views/categories/add_money/add_money_preview_screen.dart';
import 'package:zeropay/views/categories/bill_pay/bill_pay_screen.dart';
import 'package:zeropay/views/categories/mobile_topup/mobile_topup_screen.dart';
import 'package:zeropay/views/categories/remittance/remitance_preview_screen.dart';
import 'package:zeropay/views/categories/send_money/qr_code_screen.dart';
import 'package:zeropay/views/categories/send_money/send_money_preview_screen.dart';
import 'package:zeropay/views/categories/send_money/send_money_screen.dart';
import 'package:zeropay/views/categories/virtual_card/flutter_wave_virtual_card/add_fund_screen.dart';
import 'package:zeropay/views/categories/virtual_card/flutter_wave_virtual_card/card_details_screen.dart';
import 'package:zeropay/views/categories/virtual_card/flutter_wave_virtual_card/fund_preview_screen.dart';
import 'package:zeropay/views/categories/withdraw/withdraw_preview_screen.dart';
import 'package:zeropay/views/drawer/bill_payment_log_screen.dart';
import 'package:zeropay/views/drawer/change_password_screen.dart';
import 'package:zeropay/views/drawer/mobile_log_screen.dart';
import 'package:zeropay/views/drawer/saved_recipient_screen.dart';
import 'package:zeropay/views/drawer/setting_screen.dart';
import 'package:zeropay/views/drawer/transaction_logs_screen.dart';
import 'package:zeropay/views/navbar/bottom_navbar_screen.dart';
import 'package:zeropay/views/navbar/dashboard_screen.dart';
import 'package:zeropay/views/navbar/notification_screen.dart';
import 'package:zeropay/views/onboard/onboard_screen.dart';
import 'package:zeropay/views/profile/2fa/enable_2fa_screen.dart';
import 'package:zeropay/views/profile/2fa/two_fa_otp_screen.dart';
import 'package:zeropay/views/profile/my_wallet_screen.dart';
import 'package:zeropay/views/profile/profile_screen.dart';
import 'package:zeropay/views/profile/update_kyc_screen.dart';
import 'package:zeropay/views/profile/update_profile_screen.dart';
